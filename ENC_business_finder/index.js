...
httpGet('http://localhost:5003/?website="'+place.website+'"&bname="'+place.name+'"&country="'+'your country'+'"&lat='+place.geometry.location.lat()+'&long='+place.geometry.location.lng())
}
}
    catch(er){
	return;
